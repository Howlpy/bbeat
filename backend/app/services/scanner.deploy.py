...
def _index_one(session: Session, path: Path) -> str:
    ...
    # No tocamos otros AlbumTrack: pueden ser álbumes personalizados a los que
    ...
    if album is None and previous_album_id:
        ...
        if previous_album and previous_album.kind == "album" and _norm(previous_album.title) == "singles":
